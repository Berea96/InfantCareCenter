      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="services.html">대여</a>
            </li>
            <li class="nav-item">
              <a class="nav-link dropdown" href="contact.html">예약-개인</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                <a class="dropdown-item" href="portfolio-1-col.html">대체교사지원</a>
                <a class="dropdown-item" href="portfolio-2-col.html">교사교육</a>
